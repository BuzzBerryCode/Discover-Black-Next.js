...
export const CreatorCard: React.FC<CreatorCardProps> = ({
  ...
  return (
    <>
      <div 
        className={`bg-white rounded-[10px] lg:rounded-[12px] xl:rounded-[15px] p-[8px] lg:p-[12px] xl:p-[15px] cursor-pointer hover:shadow-lg transition-all duration-200 border-0 shadow-sm ${className}`}
